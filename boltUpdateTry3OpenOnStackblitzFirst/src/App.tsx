...
import { Search, Settings, RefreshCw, Zap, ChevronDown, ChevronUp, Mail, Menu, X, Quote } from 'lucide-react';
...
function App() {
  ...
  const testimonials = [
    {
      name: "Sarah Johnson",
      role: "Operations Manager, Harbor Hotel Group",
      image: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80",
      quote: "The AI voice caller system has revolutionized our reservation process. We've seen a 40% reduction in missed bookings and our staff can now focus on providing exceptional service to in-house guests."
    },
    {
      name: "Michael Rodriguez",
      role: "Owner, Fusion Restaurant",
      image: "https://images.unsplash.com/photo-1560250097-0b93528c311a?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80",
      quote: "Since implementing Lightning Strategy's AI chatbot on our website, our online orders have increased by 35%. The system handles reservations flawlessly and our customers love the instant responses at any time of day."
    },
    {
      name: "Emily Chen",
      role: "Director of Digital Marketing, TechCorp",
      image: "https://images.unsplash.com/photo-1580489944761-15a19d654956?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80",
      quote: "The workflow automation solution developed by Lightning Strategy has streamlined our lead qualification process. What used to take our team hours now happens automatically, and with greater accuracy."
    },
    {
      name: "James Wilson",
      role: "CEO, Evergreen Catering",
      image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80",
      quote: "Our website redesign exceeded all expectations. Not only does it look stunning, but the integration with our booking system and AI assistants has transformed how we do business. The ROI was evident within the first month."
    }
  ];
  ...
  return (
    <div className="relative min-h-screen bg-black overflow-hidden">
      ...
      <section id="testimonials-section" className="relative z-10 py-16 px-4 bg-black bg-opacity-40">
        <div className="absolute inset-0 z-0 opacity-20">
          <div className="testimonial-glow"></div>
        </div>
        
        <h2 className="text-5xl font-bold text-center mb-16">Client Success Stories</h2>
        
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          {testimonials.map((testimonial, index) => (
            <div 
              key={index}
              className={`testimonial-card ${hoveredTestimonial === index ? 'testimonial-hovered' : ''}`}
              onMouseEnter={() => setHoveredTestimonial(index)}
              onMouseLeave={() => setHoveredTestimonial(null)}
            >
              <div className="p-6 relative">
                <div className="quote-icon absolute top-4 right-4 text-orange-500/20">
                  <Quote className="w-12 h-12" />
                </div>
                
                <p className="text-white mb-6 relative z-10 italic">"{testimonial.quote}"</p>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    <h4 className="text-orange-400 font-bold text-lg">{testimonial.name}</h4>
